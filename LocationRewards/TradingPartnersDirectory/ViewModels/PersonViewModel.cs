...
namespace TradingPartnersDirectory.ViewModels
{
	public class PersonViewModel : ViewModelBase
	{
		...
		public PersonViewModel (Person person, IFavoritesRepository favoritesRepository)
		{
			...
			general.Add ("Description", person.Title, PropertyType.Generic);
			general.Add ("Price", person.Department, PropertyType.Generic);
			...
			var photo = new PropertyGroup ("Product Image");
			photo.Add ("ProductPhoto", person.ImageUrl, PropertyType.Photo);
			if (photo.Properties.Count > 0) {
				PropertyGroups.Add (photo);
			}

			var online = new PropertyGroup ("Payment Options");
			//online.Add ("Email", person.Email, PropertyType.Email);
			//online.Add ("Buy", "Buy for GBP " + person.Department, PropertyType.Email);
			online.Add ("Online payment", "Buy for GBP " + person.Department, PropertyType.Email);
			...
			online.Add ("Clubcard", CleanTwitter (person.Twitter), PropertyType.Twitter);
